...
module.exports = {"author":"Ben Newman <bn@cs.stanford.edu>","name":"recast","description":"JavaScript syntax tree transformer, nondestructive pretty-printer, and automatic source map generator","keywords":["ast","rewriting","refactoring","codegen","syntax","transformation","parsing","pretty-printing"],"version":"0.14.7","homepage":"http://github.com/benjamn/recast","repository":{"type":"git","url":"git://github.com/benjamn/recast.git"},"license":"MIT","main":"main.js","scripts":{"test":"test/run.sh","debug":"test/run.sh --inspect-brk"},"browser":{"fs":false},"dependencies":{"ast-types":"0.11.3","esprima":"~4.0.0","private":"~0.1.5","source-map":"~0.6.1"},"devDependencies":{"@babel/core":"^7.0.0-beta.40","@babel/preset-es2015":"^7.0.0-beta.40","babylon":"^7.0.0-beta.42","esprima-fb":"^15001.1001.0-dev-harmony-fb","flow-parser":"^0.68.0","glob":"^7.1.2","mocha":"~5.0.0","reify":"^0.14.1","semver":"^5.3.0"},"engines":{"node":">= 4"}}
...
module.exports = {"name":"css","version":"2.2.3","description":"CSS parser / stringifier","main":"index","files":["index.js","lib","Readme.md"],"dependencies":{"inherits":"^2.0.1","source-map":"^0.1.38","source-map-resolve":"^0.5.1","urix":"^0.1.0"},"devDependencies":{"mocha":"^1.21.3","should":"^4.0.4","matcha":"^0.5.0","bytes":"^1.0.0"},"scripts":{"benchmark":"matcha","test":"mocha --require should --reporter spec --bail test/*.js"},"author":"TJ Holowaychuk <tj@vision-media.ca>","license":"MIT","repository":{"type":"git","url":"https://github.com/reworkcss/css.git"},"keywords":["css","parser","stringifier","stylesheet"]}
...
module.exports = {"name":"jscodeshift","version":"0.5.0","description":"A toolkit for JavaScript codemods","repository":{"type":"git","url":"https://github.com/facebook/jscodeshift.git"},"bugs":"https://github.com/facebook/jscodeshift/issues","main":"index.js","scripts":{"prepublish":"cp -R src/ dist/","test":"jest --bail","docs":"rm -rf docs && jsdoc -d docs -R README.md src/collections/* src/core.js src/Collection.js"},"bin":{"jscodeshift":"./bin/jscodeshift.sh"},"engines":{"node":">=4"},"keywords":["codemod","recast"],"author":"Felix Kling","license":"BSD-3-Clause","dependencies":{"babel-plugin-transform-flow-strip-types":"^6.8.0","babel-preset-es2015":"^6.9.0","babel-preset-stage-1":"^6.5.0","babel-register":"^6.9.0","babylon":"^7.0.0-beta.30","colors":"^1.1.2","flow-parser":"^0.*","lodash":"^4.13.1","micromatch":"^2.3.7","neo-async":"^2.5.0","node-dir":"0.1.8","nomnom":"^1.8.1","recast":"^0.14.1","temp":"^0.8.1","write-file-atomic":"^1.2.0"},"devDependencies":{"babel-eslint":"^6.1.2","eslint":"^3.1.1","jest":"^18.1.0","jsdoc":"^3.4.0","mkdirp":"^0.5.1"},"jest":{"testPathDirs":["src","bin","sample"]}}
...
module.exports = {"name":"@glimmer/compiler","version":"0.34.6","repository":"https://github.com/glimmerjs/glimmer-vm/tree/master/packages/@glimmer/compiler","dependencies":{"@glimmer/syntax":"^0.34.6","@glimmer/util":"^0.34.6","@glimmer/wire-format":"^0.34.6","@glimmer/interfaces":"^0.34.6"},"devDependencies":{"typescript":"^2.2.0"},"main":"dist/commonjs/es5/index.js","jsnext:main":"dist/modules/es5/index.js","module":"dist/modules/es2017/index.js","typings":"dist/types/index.d.ts","license":"MIT"}
...
module.exports = {"name":"@webassemblyjs/wast-parser","version":"1.5.6","description":"WebAssembly text format parser","keywords":["webassembly","javascript","ast","parser","wat","wast"],"main":"lib/index.js","scripts":{"test":"mocha"},"author":"Sven Sauleau","license":"MIT","dependencies":{"@webassemblyjs/ast":"1.5.6","@webassemblyjs/floating-point-hex-parser":"1.5.6","@webassemblyjs/helper-api-error":"1.5.6","@webassemblyjs/helper-code-frame":"1.5.6","@webassemblyjs/helper-fsm":"1.5.6","long":"^3.2.0","mamacro":"^0.0.3"},"devDependencies":{"@webassemblyjs/helper-test-framework":"1.5.6"},"repository":{"type":"git","url":"https://github.com/xtuc/webassemblyjs.git"},"publishConfig":{"access":"public"}}
...
module.exports = {"name":"babel-plugin-macros","version":"2.2.1","description":"Enables zero-config, importable babel plugins","main":"dist/index.js","scripts":{"add-contributor":"kcd-scripts contributors add","build":"kcd-scripts build","lint":"kcd-scripts lint","test":"kcd-scripts test","test:update":"npm test -- --updateSnapshot","validate":"kcd-scripts validate","setup":"npm install && npm run validate -s","precommit":"kcd-scripts precommit"},"files":["dist"],"keywords":["babel-plugin","macros","macro","babel-macro","babel-plugin-macro"],"author":"Kent C. Dodds <kent@doddsfamily.us> (http://kentcdodds.com/)","license":"MIT","dependencies":{"cosmiconfig":"^4.0.0"},"devDependencies":{"ast-pretty-print":"^2.0.1","babel-core":"7.0.0-beta.3","babel-plugin-tester":"^5.0.0","babel-types":"^6.26.0","babylon":"7.0.0-beta.34","cpy":"^6.0.0","kcd-scripts":"^0.32.1"},"eslintConfig":{"extends":"./node_modules/kcd-scripts/eslint.js"},"eslintIgnore":["node_modules","coverage","dist"],"babel":{"presets":["./other/babel-config.js"]},"repository":{"type":"git","url":"https://github.com/kentcdodds/babel-plugin-macros.git"},"bugs":{"url":"https://github.com/kentcdodds/babel-plugin-macros/issues"},"homepage":"https://github.com/kentcdodds/babel-plugin-macros#readme"}
...
module.exports = {"name":"@glimmer/syntax","version":"0.34.6","repository":"https://github.com/glimmerjs/glimmer-vm/tree/master/packages/@glimmer/syntax","dependencies":{"handlebars":"^4.0.6","@glimmer/interfaces":"^0.34.6","@glimmer/util":"^0.34.6","simple-html-tokenizer":"^0.5.1"},"devDependencies":{"@types/handlebars":"^4.0.31","@types/qunit":"^2.0.31","typescript":"^2.2.0"},"main":"dist/commonjs/es5/index.js","jsnext:main":"dist/modules/es5/index.js","module":"dist/modules/es2017/index.js","typings":"dist/types/index.d.ts","license":"MIT"}
...
module.exports = {"name":"prettier","version":"1.12.1","description":"Prettier is an opinionated code formatter","bin":"./bin-prettier.js","repository":"prettier/prettier","homepage":"https://prettier.io","author":"James Long","license":"MIT","main":"./index.js","engines":{"node":">=4"},"devDependencies":{"babel-cli":"6.24.1","babel-preset-es2015":"6.24.1","codecov":"2.2.0","cross-env":"5.0.5","eslint":"4.18.2","eslint-config-prettier":"2.9.0","eslint-friendly-formatter":"3.0.0","eslint-plugin-import":"2.9.0","eslint-plugin-prettier":"2.6.0","eslint-plugin-react":"7.7.0","jest":"21.1.0","mkdirp":"0.5.1","prettier":"1.12.0","prettylint":"1.0.0","rimraf":"2.6.2","rollup":"0.47.6","rollup-plugin-commonjs":"8.2.6","rollup-plugin-json":"2.1.1","rollup-plugin-node-builtins":"2.0.0","rollup-plugin-node-globals":"1.1.0","rollup-plugin-node-resolve":"2.0.0","rollup-plugin-replace":"1.2.1","shelljs":"0.8.1","snapshot-diff":"0.2.2","strip-ansi":"4.0.0","tempy":"0.2.1","uglify-es":"3.3.9","webpack":"2.6.1"},"scripts":{"prepublishOnly":"node -e \"assert.equal(require('.').version, require('..').version)\""},"files":["*.js"]}
...
module.exports = {"name":"redot","version":"0.4.1","description":"Graphviz dot processor powered by plugins","main":"redot.js","files":["redot.js"],"scripts":{"test":"echo \"Error: no test specified\" && exit 1"},"repository":{"type":"git","url":"git+https://github.com/redotjs/redot.git"},"keywords":["graphviz","dot","astract","syntax","tree","ast","parse","stringify","process"],"author":{"name":"Christian Murphy","email":"Christian.Murphy.42@gmail.com","url":"https://github.com/ChristianMurphy"},"license":"MIT","bugs":{"url":"https://github.com/redotjs/redot/issues"},"homepage":"https://github.com/redotjs/redot#readme","dependencies":{"redot-parse":"^0.4.1","redot-stringify":"^0.4.1","unified":"^6.1.6"}}
